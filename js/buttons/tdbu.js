...
function homeFirst(){
"use strict"; 
	   	   document.location="./"+"tdbu"+pageNumber[0]; 
}
//latest
function homeLatest(){
"use strict";
	   	   document.location="./"+"tdbu"+pageNumber[i]; 
}
...
function archiveOne(){
"use strict";
	window.alert("./"+"tdbu"+pageNumber[1]);
	   	   document.location="./"+"tdbu"+pageNumber[1]; 
}
